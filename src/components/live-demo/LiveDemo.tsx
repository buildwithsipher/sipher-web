...
const inferCategory = (text: string): ActivityCategory => {
  ...
  if (lower.includes("launched") || lower.includes("published") || lower.includes("campaign")) return "Growth";
  if (lower.includes("fixed") || lower.includes("added") || lower.includes("improved") || lower.includes("enabled")) return "Product";
  if (lower.includes("negotiated") || lower.includes("supplier") || lower.includes("onboarded") || lower.includes("shops")) return "Ops";
  if (lower.includes("interview") || lower.includes("feedback") || lower.includes("campaign")) return "Content";
  if (lower.includes("reduced") || lower.includes("cost") || lower.includes("closed") || lower.includes("retail")) return "Revenue";

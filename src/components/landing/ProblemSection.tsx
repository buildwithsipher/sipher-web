...
export default function ProblemSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          'radial-gradient(circle at 20% 50%, rgba(139, 92, 246, 0.04) 0%, transparent 50%), #0b0b0c',
      }}
    >
      <div className="max-w-[750px] mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-white leading-tight mb-6 md:mb-8">
            You build. You ship. But your <span className="text-purple-400">execution</span> stays
            invisible.
          </h2>
        ...
        >
          ...
          <p className="text-base md:text-lg text-white/80 leading-relaxed">
            ...
            visible — not your credentials, not your network, but your actual work.
          </p>
        </motion.div>
      </div>
    </section>

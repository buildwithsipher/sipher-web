...
export async function POST(request: NextRequest) {
  try {
    ...
    if (validatedData.what_building)
      sanitizedData.what_building = sanitizeTagline(validatedData.what_building, 500)
    if (validatedData.website_url)
      sanitizedData.website_url = sanitizeUrl(validatedData.website_url)
    if (validatedData.linkedin_url)
      sanitizedData.linkedin_url = sanitizeUrl(validatedData.linkedin_url)

    ...
    <div className="min-h-screen bg-[#0B0B0C] text-white">
      <div className="container mx-auto px-4 sm:px-6 py-12 md:py-20">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-black text-center mb-4">Terms of Service</h1>
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-xl p-8 md:p-12 space-y-8">
            <section>
              ...
              <p className="text-white/70 leading-relaxed">
                By accessing or using Sipher, you agree to be bound by these Terms of Service. If
            ...
            <section>
              ...
              <p className="text-white/70 leading-relaxed mb-4">
                Permission is granted to temporarily use Sipher for personal, non-commercial use
            ...
            <section>
              ...
              <p className="text-white/70 leading-relaxed">
                You retain ownership of any content you submit to Sipher. By submitting content, you
                grant us a license to use, display, and distribute your content on the platform for
            ...
            <section>
              ...
              <p className="text-white/70 leading-relaxed">
                In no event shall Sipher or its suppliers be liable for any damages arising out of
                the use or inability to use Sipher, even if Sipher has been notified of the

...
export const metadata: Metadata = {
  ...
  description: "The operating system for India's founders. Proof over promises.",
  keywords: ['startup', 'founder', 'india', 'proof of execution', 'buildlog', 'vc funding'],
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "The operating system for India's founders. Where execution becomes credential.",
              sameAs: ['https://twitter.com/sipher', 'https://linkedin.com/company/sipher'],
            }),
          }}
        />
      </head>

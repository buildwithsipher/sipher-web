...
export function activationEmail({
  ...
  return {
    subject: 'Your Sipher access is ready ✦',
    html: `
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Sipher Access Live</title>
        </head>
        <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #000000; color: #ffffff;">
          <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            <!-- Logo -->
            ...
            <!-- Main Content -->
            <div style="background: linear-gradient(135deg, rgba(139, 92, 246, 0.1) 0%, rgba(0, 0, 0, 0) 100%); border: 1px solid rgba(139, 92, 246, 0.3); border-radius: 16px; padding: 40px; margin-bottom: 24px; position: relative; overflow: hidden;">
              <!-- Glow effect -->
              <div style="position: absolute; top: -50%; right: -50%; width: 100%; height: 100%; background: radial-gradient(circle, rgba(139, 92, 246, 0.3) 0%, transparent 70%); pointer-events: none;"></div>
              
              <div style="position: relative; z-index: 1;">
                <div style="text-align: center; margin-bottom: 24px;">
                  <div style="display: inline-block; background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 50%; padding: 20px; margin-bottom: 16px;">
                    <span style="font-size: 48px;">✓</span>
                  </div>
                </div>

                <h2 style="font-size: 28px; font-weight: 700; margin: 0 0 12px 0; text-align: center;">
                  You're Approved, ${name}
                </h2>
                
                <p style="font-size: 16px; color: #9CA3AF; margin: 0 0 32px 0; line-height: 1.6; text-align: center;">
                  Your Sipher access has been approved.<br>
                  Welcome to the first 50.
                </p>

                <div style="text-align: center; margin: 32px 0;">
                  <a href="${activationUrl}" style="display: inline-block; background: linear-gradient(to right, #8B5CF6, #6366F1); color: white; text-decoration: none; padding: 18px 48px; border-radius: 12px; font-weight: 700; font-size: 18px; box-shadow: 0 10px 40px rgba(139, 92, 246, 0.4);">
                    Sign In to Sipher →
                  </a>
                </div>
                ...
                <div style="background: rgba(0, 0, 0, 0.5); border-radius: 8px; padding: 20px; margin-top: 32px;">
                  ...
                  <ul style="margin: 0; padding-left: 20px; color: #9CA3AF; font-size: 14px; line-height: 1.8;">
                    <li>Start logging your daily work (BuilderLog)</li>
                    <li>Watch your ProofCard score build</li>
                    <li>Access founder resources and playbooks</li>
                    <li>Join The Forge (high-trust community)</li>
                  </ul>
                </div>

                <p style="font-size: 13px; color: #6B7280; margin: 24px 0 0 0; text-align: center; line-height: 1.6;">
                  This link works only once and expires in 24 hours.<br>
            ...
            <div style="background: #0a0a0a; border: 1px solid #1a1a1a; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
              <p style="margin: 0; font-size: 14px; color: #9CA3AF; line-height: 1.6; font-style: italic; text-align: center;">
                ...
                You're here because of what you <strong style="color: #8B5CF6; font-style: normal;">build</strong>."
              </p>
            </div>
